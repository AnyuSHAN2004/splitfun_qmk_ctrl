...
这是一款基于 RP2040、专为分体键盘设计的主控板。主控板采用四层 PCB，测试板采用双层 PCB。测试板为可选配件，仅用于方便编程和测试。
...
项目暂不提供 BOM 表，请参照原理图中的元件参数及 PCB 丝印进行组装。

A BOM is not currently provided. Refer to the component specifications in the schematic and the PCB silkscreen for assembly.
